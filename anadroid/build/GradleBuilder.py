...
from anadroid.build.GracleBuildErrorSolver import is_known_error, solve_known_error, KNOWN_ERRORS
...
ndk-location={android_home}/ndk-bundle'''\
    ...
    def was_last_build_successful(self, task="build"):
        print(self.last_build_info)
        return self.last_build_info[task].lower() == SUCCESS_VALUE.lower() if task in self.last_build_info else False
    ...
    def regist_successfull_build(self, task="build"):
        ...
        self.last_build_info[task] = SUCCESS_VALUE
