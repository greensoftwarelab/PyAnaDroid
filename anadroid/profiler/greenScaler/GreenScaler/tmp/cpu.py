...
class CPU:
	...
	def cpu_before(self, pkg_name):
		subprocess.call("adb shell sh /sdcard/cpu_before.sh "+ pkg_name, shell=True)		
	
	def cpu_after(self, pkg_name):	

		subprocess.call("adb shell sh /sdcard/cpu_jiffy.sh "+ pkg_name, shell=True)
		subprocess.call("adb shell sh /sdcard/cpu_after.sh "+ pkg_name, shell=True)	
