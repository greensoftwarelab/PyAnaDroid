...
# Example command to run on calculator app
# python mutator_main.py start.sh 2700 com.android2.calculator3 Calculator-debug-00083-65cbad5.apk 852 
...
def convert_to_gm(apk,package, activity):
	...
	fr=open(utils.BASE_PATH+"mutator/tests/best_test_emu_"+package+".sh","r")
...
if __name__=='__main__':
    ...
    parser.add_argument('time',
                        type=int, 
                        help="Amount of time in seconds you want the " \
                        + "program to run for")
    #parser.add_argument('package', 
     #                   help="Main package name of app")
    #parser.add_argument('apk', 
    #                    help="App apk file")
    #parser.add_argument('total_num_methods', 
     #                   type=int,
      #                  help="Total number of methods of an apk under a " \
       #                 + "given package")
    ...
    for apk_file in listdir(utils.APKS_PATH):
		...
		number_of_events=randint(10,40)
		...
		f_duration.close()
   	 	shutil.copy2(utils.BASE_PATH+"/mutator/tests/"+mutator.test.name, utils.BASE_PATH+"mutator/tests/best_test_emu_"+package+".sh")
		shutil.copy2(utils.BASE_PATH+"mutator/tests/best_test_emu_"+package+".sh", utils.BEST_EMU_PATH+package+".sh")
